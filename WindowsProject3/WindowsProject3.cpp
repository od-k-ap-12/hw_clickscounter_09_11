...
{
    TCHAR str[50];
    static int LClicksCount = 0;
    static int RClicksCount = 0;
    static int MClicksCount = 0;
    switch (message)
    {
    case WM_RBUTTONDOWN:
        ++RClicksCount;
        _stprintf_s(str, TEXT("LClicks=%d  RClicks=%d MClicks=%d"), LClicksCount, RClicksCount,MClicksCount);
